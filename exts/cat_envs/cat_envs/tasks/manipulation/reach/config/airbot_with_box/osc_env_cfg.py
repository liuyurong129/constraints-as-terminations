...
# Pre-defined configs
##
from isaaclab_assets.robots.airbot_box import AIRBOT_BOX_CFG  # isort: skip

@configclass
class AirbotBoxEnvCfg(joint_pos_env_cfg.AirbotBoxEnvCfg):
    def __post_init__(self):
        ...
        self.scene.robot.actuators["airbot_arm_box"].stiffness = 0.0
        self.scene.robot.actuators["airbot_arm_box"].damping = 0.0
